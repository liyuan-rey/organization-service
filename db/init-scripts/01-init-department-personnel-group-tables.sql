...
INSERT INTO b_org_department (id, name, english_name, short_name, org_code, phone, fax, email, address, postal_code) VALUES 
    (1, 'Human Resources Department', 'Human Resources Department', 'HR', 'ORG-HR-001', '+1-555-0101', '+1-555-0102', 'hr@company.com', '123 Main Street, New York, NY 10001', '10001'),
    (2, 'Technology Department', 'Technology Department', 'Tech', 'ORG-TECH-001', '+1-555-0103', '+1-555-0104', 'tech@company.com', '456 Innovation Blvd, San Francisco, CA 94102', '94102'),
    (3, 'Development Division', 'Development Division', 'Dev', 'ORG-DEV-001', '+1-555-0105', '+1-555-0106', 'dev@company.com', '789 Code Street, San Francisco, CA 94103', '94103')
...
INSERT INTO b_org_personnel (id, name, gender, id_card, mobile, telephone, fax, email) VALUES 
    (1, 'John Smith', 'M', 'S123456789', '+1-555-0105', '+1-555-0106', '+1-555-0107', 'john.smith@company.com'),
    (2, 'Jane Doe', 'F', 'D987654321', '+1-555-0108', '+1-555-0109', '+1-555-0110', 'jane.doe@company.com'),
    (3, 'Bob Johnson', 'M', 'J456789123', '+1-555-0111', '+1-555-0112', '+1-555-0113', 'bob.johnson@company.com')
ON CONFLICT (id) DO NOTHING;

-- Insert sample data for group
INSERT INTO b_org_group (id, name, description) VALUES 
    (1, 'Development Team', 'Responsible for software development'),
    (2, 'QA Team', 'Responsible for software testing'),
    (3, 'DevOps Team', 'Responsible for infrastructure and deployment')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO r_org_entity_relation (id, source_type, source_id, target_type, target_id, relation_type, level, path, sort_order, is_direct) VALUES
    (1, 'department', 1, 'department', 2, 'parent_of', 1, '1', 1, true), -- HR department is parent of Tech department
    (2, 'department', 2, 'department', 3, 'parent_of', 2, '1,2', 1, true); -- Tech department is parent of Dev division
...
INSERT INTO r_org_entity_relation (id, source_type, source_id, target_type, target_id, relation_type, attributes) VALUES
    (3, 'personnel', 1, 'department', 1, 'belongs_to', '{"position": "HR Manager", "is_primary": true}'),
    (4, 'personnel', 2, 'department', 2, 'belongs_to', '{"position": "Tech Lead", "is_primary": true}'),
    (5, 'personnel', 3, 'department', 3, 'belongs_to', '{"position": "Developer", "is_primary": true}');

-- Personnel-group relationships
INSERT INTO r_org_entity_relation (id, source_type, source_id, target_type, target_id, relation_type, attributes) VALUES
    (6, 'personnel', 2, 'group', 1, 'member_of', '{"role": "Team Lead"}'),
    (7, 'personnel', 3, 'group', 1, 'member_of', '{"role": "Developer"}'),
    (8, 'personnel', 3, 'group', 3, 'member_of', '{"role": "DevOps Engineer"}');

-- Department-group relationships
INSERT INTO r_org_entity_relation (id, source_type, source_id, target_type, target_id, relation_type, attributes) VALUES
    (9, 'department', 2, 'group', 1, 'contains', '{"function": "Software Development"}'),
    (10, 'department', 2, 'group', 2, 'contains', '{"function": "Quality Assurance"}'),
    (11, 'department', 3, 'group', 3, 'contains', '{"function": "Infrastructure"}');